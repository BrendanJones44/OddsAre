  ...
  describe "#show" do
    ...
    context "authenticated user" do
      ...
      context "who is the recipient of the notification" do
        ...
        context "and the notification hasn't been read yet" do
        ...
        context "and the notification has already been read" do
          ...
          let(:odds_are) { FactoryGirl.create(:odds_are, :notification => subject) }
          it "shouldn't override the notifications timestamp" do
            expect{ get :show, params: { id: odds_are.id }}.to_not change{subject.acted_upon_at}
          end
        end
      end

      context "who is isn't the recipient of the notification" do
