  ...
  describe "POST #accept_friend_request" do
    ...
    context "authenticated user" do
      ...
      context "requests with existing alternate user" do
        ...
        context "and accepting user didn't receive a friend request from other user" do
          it "should respond with an error" do
        ...
        context "and accepting user sent the user a friend request" do
          ...
          it "should have updated other user's friend requests" do
          ...
          it "should recognize user as other_user's friend" do
