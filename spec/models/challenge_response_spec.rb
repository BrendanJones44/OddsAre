...
RSpec.describe ChallengeResponse, type: :model do
  ...
  it { is_expected.to validate_presence_of(:odds_out_of).
                      with_message('You must say what the odds are out of') }

  it { is_expected.to validate_presence_of(:number_chosen).
  ...
  describe "#number_chosen_in_bounds" do
    context "with number chosen being equal to what it's set out of" do
    ...
    context "with number chosen being greater than what it's set out of" do
